...
track library, event setlists whose entries each carry their own fades and edit
points, plus a big fader on the system output volume. It shares nothing with the plugins --
