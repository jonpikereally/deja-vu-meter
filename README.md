...
imported from Files/iCloud/Dropbox/Drive with per-song fades and edit points,
event setlists, and a large fader on the system output volume. Unrelated to the plugins: SwiftUI, no JUCE, built in
